...
function UserInfo() {
  ...
  const confirmEmail = async () => {
    const res = await axios.post("/api/user/signup/val_email", {
      email: email,
    });
  ...
  const confirmName = async () => {
    const res = await axios.post("/api/user/signup/val_nickname", {
      nickname: nickname,
    });
  ...
  const signup = () => {
    ...
    axios.post("/api/user/signup", formDataRegister, {
      headers: {
      ...
      <div css={option_box}>
        <div>
          ...
          <div css={profile_img}>
            <Avatar
              alt="profile img"
              src={typeof profileImage == "string" ? profileImage : ""}
