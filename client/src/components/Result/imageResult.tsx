        ...
        <div style={{width:'100%',display:'flex',justifyContent:'center'}}>
            {img ? 
                <Card sx={{ maxWidth: 500, marginBottom:'5%' }}>
                    ...
                    <CardContent sx={{textAlign:'center'}}>
                        ...
                        <Typography variant="h4" color="#897A5F" sx={{fontFamily:'Elice', fontWeight:'600'}}>
                        {resultRate}%
                        </Typography>
                    </CardContent>
                    {secondCheck || thirdCheck ? <p style={{marginTop:'1rem', marginLeft:'3rem'}}>유사 검색어</p> : ""}
            ...
            {resultState ? 
                <Card 
                    ...
                    <CardContent sx={{textAlign:'center'}}>
                        <Typography variant="h5" component="div" sx={{paddingBottom:'10px',marginTop:'1rem', fontFamily:'Elice'}}>
                        검색 결과를 찾을 수 없습니다.
                        </Typography>
                        <Typography variant="body2" sx={{fontFamily:'Elice'}}>
                        검색하신 이미지에 일치하는 결과를 찾을 수 없습니다. 촬영가이드를 참고하여 다시 검색하거나 텍스트 검색을 이용해주세요.
                        <br />
                        </Typography>
                    </CardContent>
