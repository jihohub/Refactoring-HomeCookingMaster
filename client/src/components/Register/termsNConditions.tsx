                ...
                <p css={service_sub_title}>서비스 약관에 동의해주세요.</p>
                    ...
                    <div css={select_cnt}>
                        ...
                        <div css={all_agree}>
                            <div >
                                ...
                                <Button 
                                    ...
                                    color="warning"
                                >보기</Button>
                                {/* <button onClick={changeBtn1}>보기</button> */}
                            </div>
                            <p css={moreBtn1 ? more_btn_show : more_btn}>
                            집밥꼬꼬선생 이용약관은 다음과 같은 내용을 담고 있습니다. (2021년 12월 1일 시행)<br />
                            제1조(목적)
                            이 약관은 전기통신사업법령 및 정보통신망이용촉진, 전자상거래 등에 관한 법령에 의하여 집밥꼬꼬선생(이하 "회사"라 합니다)이 제공하는 집밥꼬꼬선생의 서비스(이하 “서비스"라 한다) 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.<br />
                            제2조(약관의 효력 및 변경)
                            ...
                            (3) 변경된 약관은 그 내용이 법령에 위배되지 않는 한 변경 이전에 회원으로 가입한 이용자에게도 적용됩니다. 변경된 약관에 이의가 있는 회원은 회사가 정한 양식에 따라 언제든지 회원등록을 취소(회원탈퇴)할 수 있으며, 약관의 효력발생일 이후의 계속적인 서비스 이용은 약관의 변경사항에 동의한 것으로 간주됩니다.<br />
                            제 3 조 (약관의 명시 및 개정)
                            1. 회사는 이 약관의 내용을 회사의 상호, 영업소 소재지, 대표자의 성명, 사업자등록번호, 연락처(전화, 팩스, 전자우편주소 등) 등과 함께 회원이 쉽게 확인할 수 있도록 서비스 초기화면 또는 연결화면에 게시합니다.
                            2. 회사는 합리적인 사유가 발생한 경우에 관련법령에 위배되지 않는 범위 안에서 이 약관을 개정할 수 있고, 시행일자 7일 이전부터 시행일 후 상당한 기간 동안 그 내용을 웹사이트 초기화면에 공지합니다. 회원의 권리의무와 관련하여 불리한 개정인 경우 그 내용을 개별적으로 통지합니다.
                            3. 개정된 약관에 동의하지 않는 회원은 언제든지 탈퇴할 수 있습니다.
                            4. 이용자는 스스로 정기적으로 웹을 방문하거나 애플리케이션을 실행하여 약관의 변경사항을 확인하여야 하고, 변경된 약관의 시행일 이후에 회원이 서비스를 계속 이용하는 경우 개정된 약관에 동의한 것으로 간주합니다.
                            5. 약관의 변경사항을 알지 못하여 발생하는 이용자의 피해는 회사에서 책임지지 않습니다.<br />
                            제 4 조 (손해배상)
                            ...
                            2. 회원 또는 회원의 피고용인, 대리인, 기타 도급 및 위임 등으로 회원을 대신하여 이용계약을 이행하는 자의 책임 있는 사유로 이용계약의 이행과 관련하여 회사에게 손해가 발생한 경우, 회원은 회사에게 발생한 손해를 배상할 책임이 있습니다.<br />
                            제 5 조 (면책조항)
                            ...
                            3. 회사는 서비스용 설비의 보수, 교체, 정기점검, 공사 등 부득이한 사유로 서비스를 제공하지 못하여 발생한 손해에 대한 책임이 면제됩니다.
                            4. 회사는 회원의 귀책사유로 인한 서비스 이용의 장애 및 그에 따른 손해에 대하여 책임을 지지 않습니다.
                            ...
                            10. 회사는 무료로 제공하는 서비스의 이용과 관련하여 회원이 손해를 입은 경우 법령에서 정한 경우를 제외하고는 어떠한 책임도 지지 않습니다.<br />
                            제 6 조 (분쟁해결과 관할법원)
                            1. 회사는 이용자로부터 제출되는 불만사항 및 의견을 지체 없이 처리하기 위하여 노력합니다. 다만 신속한 처리가 곤란한 경우에는 이용자에게 그 사유와 처리 일정을 통보합니다.
                        ...
                        <div css={all_agree}>
                            ...
                            <p css={moreBtn2 ? more_btn_show : more_btn}>
