...
- 계획
    ...
    - SASS 도입 : 기존 프로젝트에서는 CSS에 대한 규칙을 정립하지 않고 CSS-in-CSS와 CSS-in-JS (styled-components), MUI 등 CSS가 중구난방으로 혼용되어 있습니다. 이를 CSS-in-CSS로 통일할 것입니다. CSS-in-CSS가 CSS-in-JS보다 로딩속도가 빨라서 SSR을 도입하는 취지와도 일맥상통하다고 느꼈습니다.
